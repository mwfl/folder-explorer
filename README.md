...
For a standalone clone, use Visual Studio 2022 or configure manually with `FOLDER_EXPLORER_USE_LOCAL_MWFL=OFF`; CMake fetches the pinned MWFL `v0.2.0` release.
